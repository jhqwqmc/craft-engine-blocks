...
public class ChunkLoaderBlockBehavior extends BukkitBlockBehavior {
    public static final BlockBehaviorFactory<ChunkLoaderBlockBehavior> FACTORY = new Factory();
    ...
    private static class Factory implements BlockBehaviorFactory<ChunkLoaderBlockBehavior> {

        @Override
        public ChunkLoaderBlockBehavior create(CustomBlock block, Map<String, Object> arguments) {
